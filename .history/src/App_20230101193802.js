  ...
  return (
    <mesh style={{ position: 'fixed' }} scale={100}>
      ...
      <LayerMaterial side={THREE.BackSide}>
        <Depth colorB="#4f4f4c" colorA="#4f4f4c" alpha={1} mode="normal" near={130} far={300} origin={[100, 100, -100]} />
        <Noise mapping="local" type="white" scale={1000} colorA="black" colorB="black" mode="subtract" alpha={0.15} />
      </LayerMaterial>
    </mesh>
  )
}
