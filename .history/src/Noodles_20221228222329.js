...
export default function Noodles() {
  ...
  function animateOut() {
    ...
    // Create a new TWEEN animation for each 3D object
    noodles.forEach((noodle) => {
      new TWEEN.Tween(noodle.props.position)
        .to({ x: noodle.props.position.x + width, y: noodle.props.position.y + height }, 500)
