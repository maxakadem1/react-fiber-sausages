...
const colorA = new THREE.Color('#000000').convertSRGBToLinear() //blue
const colorB = new THREE.Color('#1f1f1f').convertSRGBToLinear() //darkblue
const fresnel = new THREE.Color('#ffffff').convertSRGBToLinear() //orange//sides of noodles
...
const material = new LayerMaterial({
  layers: [
    ...
    new Depth({ colorA: '#1f1f1f', colorB: colorB, alpha: 0.5, mode: 'add', near: 3, far: 2, origin: [1, 1, 1] }),
    new Fresnel({ mode: 'add', color: fresnel, intensity: 0.3, power: 2.5, bias: 0.0 }),
    new Noise({ mapping: 'local', type: 'simplex', scale: 1000, colorA: '#1f1f1f', colorB: 'gray', mode: 'overlay' })
  ]
})
