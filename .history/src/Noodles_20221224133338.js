...
const colorA = new THREE.Color('#adadad').convertSRGBToLinear()
const colorB = new THREE.Color('#404040').convertSRGBToLinear()
...
const material = new LayerMaterial({
  layers: [
    new Base({ color: colorA }),
    new Depth({ colorA: colorA, colorB: colorB, alpha: 0.5, mode: 'normal', near: 0, far: 2, origin: [1, 1, 1] }),
    new Depth({ colorA: 'white', colorB: colorB, alpha: 0.5, mode: 'add', near: 3, far: 2, origin: [1, 1, 1] }),
    new Fresnel({ mode: 'add', color: fresnel, intensity: 0.3, power: 2.5, bias: 0.0 }),
    new Noise({ mapping: 'local', type: 'simplex', scale: 1000, colorA: '#262626', colorB: 'black', mode: 'overlay' })
  ]
})
