...
function Overlay() {
  ...
  return (
    <AnimatedPage>
      <div style={{ position: 'fixed', zIndex: 100000, top: 0, left: 0, pointerEvents: 'none', width: '100%', height: '100%' }}>
        <Link ref={a2Ref} to="/Ux" style={{ position: 'absolute', top: 40, left: 40, fontSize: '13px' }}>
          UI/UX design
        </Link>
        <Link ref={a1Ref} to="/frontend" style={{ position: 'absolute', top: 60, left: 40, fontSize: '13px' }}>
          frontend
        </Link>
