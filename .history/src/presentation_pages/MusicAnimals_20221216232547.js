  ...
  return (
    <div
      ...
      <div className="image-library">
        ...
        <img className="image-item" src={pic1} alt="img2" />
        <img className="image-item" src={pic1} alt="img3" />
        <img className="image-item" src={pic1} alt="img4" />
        <img className="image-item" src={pic1} alt="img5" />
        <img className="image-item" src={pic1} alt="img6" />
        <img className="image-item" src={pic1} alt="img7" />
        <img className="image-item" src={pic1} alt="img8" />
        <img className="image-item" src={pic1} alt="img9" />
      </div>
    </div>
  )
}
