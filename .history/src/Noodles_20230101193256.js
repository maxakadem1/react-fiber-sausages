...
const colorA = new THREE.Color('#2032A5').convertSRGBToLinear() //blue
const colorB = new THREE.Color('#0F1C4D').convertSRGBToLinear() //darkblue
const fresnel = new THREE.Color('#f7f2eb').convertSRGBToLinear() //orange//sides of noodles
